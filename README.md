About cpcm-x-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cpcm-x-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/grimme-lab/cpcm-x

Package license: LGPL-3.0-or-later

Summary: Extended conductor-like polarizable continuum solvation model
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27134&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cpcm-x-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
Installing `cpcm-x` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
pixi add cpcm-x cpcm-x-devel
# for installing globally
pixi global install cpcm-x cpcm-x-devel
```
...
It is possible to list all of the versions of `cpcm-x` available on your platform:

<details>
<summary>With conda</summary>

```
conda search cpcm-x --channel conda-forge
```
...
```
mamba search cpcm-x --channel conda-forge
```
...
```
pixi search cpcm-x --channel conda-forge
```
...
mamba repoquery search cpcm-x --channel conda-forge

# List packages depending on `cpcm-x`:
mamba repoquery whoneeds cpcm-x --channel conda-forge

# List dependencies of `cpcm-x`:
mamba repoquery depends cpcm-x --channel conda-forge
```
...
Updating cpcm-x-feedstock
=========================

If you would like to improve the cpcm-x recipe or build a new
...
Note that all branches in the conda-forge/cpcm-x-feedstock are
